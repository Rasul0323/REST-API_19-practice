...
import guru.qa.tests.models.*;
import java.util.HashSet;
import java.util.LinkedList;
import static guru.qa.tests.specs.Specs.*;
...
public class ReqresInExtendedTests extends TestBase {
    ...
    void successfulJsonSchemaTest() {
        ...
        requestBody.setEmail(email);
        requestBody.setPassword(password);
        String pathToScheme = "schemes/status-response-scheme.json";
    ...
    @Test
    void failedUserRegistrationWithSpecsTest() {
